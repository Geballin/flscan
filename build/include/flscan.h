...
public:
  EatEvent(int x,int y,int w,int h,const char *l=0);
  int handle(int e);
};
...
extern Fl_Tabs *FlScanOptions;
#include <FL/Fl_Scroll.H>
extern Fl_Scroll *FlScanScannerOptions;
extern Fl_Scroll *FlScanApplicationOptions;
extern Fl_Group *FlScanSettings;
extern Fl_Group *FlScanMisc;
#include <FL/Fl_Choice.H>
extern Fl_Choice *FlScanScanFileType;
...
extern Fl_Input *FlScanTxFixedType;
extern Fl_Group *FlScanIntGroup;
extern Fl_Input *FlScanTxIntType;
...
extern Fl_Choice *FlScanMnListType;
...
extern Fl_Input *FlScanTxGammaTable;
...
extern Fl_Choice *FlScanOmZoomFilter;
...
extern Fl_Scroll *FlScanSwViewArea;
...
void update_tree();
void update_scanner_tree();
void update_application_tree();
